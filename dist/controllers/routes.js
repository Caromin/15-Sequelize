...
router.get("/", function (req, res) {
  ...
  models.Burger.findAll({ raw: true }).then(function (found) {
...
router.post('/create', function (req, res) {
  ...
  models.Burger.create({ burgerName: req.body.burgerName.toString() }).then(function (newBurger) {
...
router.put('/update', function (req, res) {
  models.Burger.update({ devoured: true }, { where: { id: parseInt(req.body.burger_id) } }).then(function (updatedData) {
...
router.delete('/update', function (req, res) {
  models.Burger.destroy({ where: { id: parseInt(req.body.burger_id) } }).then(function (deletedData) {
