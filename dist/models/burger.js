...
var orm = require('../controllers/orm.js');
...
var burger = {
  ...
  insertOne: function insertOne(burgerNameCreated, cbisfunctionPassedfromControllers) {
    orm.insertOne("burgers", ["burger_name", "devoured"], [burgerNameCreated, false], cbisfunctionPassedfromControllers);
  },

  updateOne: function updateOne(burgerId, cb) {
    orm.updateOne('burgers', burgerId, true, cb);
  },

  deleteOne: function deleteOne(burgerId, cb) {
